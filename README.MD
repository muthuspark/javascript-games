...
- 27 fun and interactive browser-based games
...
| **Tangram** | Arrange seven geometric pieces to match silhouette puzzles |
| **Binary Puzzle** | Fill grids with 0s and 1s following Takuzu rules |
| **Sokoban** | Push boxes onto target locations in this classic puzzle game |
